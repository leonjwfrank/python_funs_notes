...
# 二项式分布(binomial distribution)举例
    掷100次骰子，
        全部为 6点的 概率为 (1/6) ** 100， 
...
# 聚类错觉(clustering illusion) 和  蒙特卡罗 模拟(Monte Carlo simulation) 的关系
...
## 全概公式(formula of total probability)
    其意义在于当直接计算A的概率困难的时候
